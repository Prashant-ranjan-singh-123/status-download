...
import com.appzeto.status.adapter.GalleryPagerAdapter;
import com.appzeto.status.utils.AdManager;
import com.appzeto.status.utils.LayManager;
...
public class MyGalleryActivity extends AppCompatActivity {
    ...
    { "Whatsapp", "WA Business", "Instagram", "Tiktok", "Twitter", "Facebook", "Vimeo", "Likee", "SnackVideo",
            "ShareChat", "Roposo", "Chingari", "Moj","Pinterest", "MX TakTak", "Mitron","Zili"};
