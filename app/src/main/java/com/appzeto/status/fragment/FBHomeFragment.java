...
import com.appzeto.status.FBVideoPlayerActivity;
import com.appzeto.status.R;
import com.appzeto.status.utils.PrefManager;
...
public class FBHomeFragment extends Fragment {
    ...
    private static final int PERMISSION_CALLBACK_CONSTANT13 = 1011;
    private static final int REQUEST_PERMISSION_SETTING = 102;

    private static final int REQUEST_PERMISSION_SETTING13 = 1022;
